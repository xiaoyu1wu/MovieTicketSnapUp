...
<script>
	...
	function showScreenSchedule(){
		$.ajax({
			...
			data:{"day":"2017-02-26", "cinemaId":"1", "movie":"刺客信条"},
			async:true,
			success:function(data, textStatus){
				...
				if(screens.length == 0){
					...
					for(var i=0; i<screens.length; i++){
						var tr = "<tr>";
						tr += "<td>" + screens[i].openTime + "</td>";
						tr += "<td>" + screens[i].movie.language + "</td>";
						tr += "<td>" + screens[i].hall + "号厅" + "</td>";
						tr += "<td>" + screens[i].price + "元" + "</td>";
						tr += "<td>" + "<a href='javascript:void(0)' onclick='buyTicket(" + screens[i].id + ")'>选座购票</a></td>";
			...
			<div class="res_cinema col-md-12">
				<div class="rs_movie_in" style="display:none">
					<div class="res_movie_pic col-md-2 text-right">
						...
						<a href="" target="_blank">
							<div class="res_movie_ann">选座购票</div>
						</a>
					</div>
