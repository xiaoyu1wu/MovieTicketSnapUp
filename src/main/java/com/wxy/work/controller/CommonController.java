...
public class CommonController {
	...
	private String index(@RequestParam(value = "movie", required = false) String movie,
	...
	private String showMovie(@RequestParam(value = "id", required = true) Integer movieId, ModelMap modelMap,
	...
	private String searchMovie(@RequestParam(value = "name", required = true) String movieName, ModelMap modelMap,
			HttpServletRequest request, HttpSession session) {

		List<Movie> movies = movieService.findMovie(movieName);
		modelMap.addAttribute("movies", movies);

		return "/common/index";
	}

	@RequestMapping(value = "/getAllCinemas")
	private String getAllCinemas(ModelMap modelMap, HttpServletRequest request, HttpSession session) {
		List<Cinema> cinemas = cinemaService.findAll();
		modelMap.addAttribute("cinemas", cinemas);
		return "/common/cinemas";

	}

	@RequestMapping(value = "searchCinema")
	private String searchCinema(@RequestParam(value = "name", required = true) String cinemaName, ModelMap modelMap,
			HttpServletRequest request, HttpSession session) {

		List<Cinema> cinemas = cinemaService.findCinemas(cinemaName);
		modelMap.addAttribute("cinemas", cinemas);
